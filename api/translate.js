  ...
  try {
    const r = await fetch('https://api.anthropic.com/v1/messages', {
      ...
      body: JSON.stringify({
        ...
        max_tokens: 1000,
        system: 'You are a literary translator specializing in Meiji and Taisho era Japanese literature. Translate with elegance, accuracy, and literary quality — preserving the voice, rhythm, and nuance of the original prose. Return ONLY the translation text, nothing else.',
